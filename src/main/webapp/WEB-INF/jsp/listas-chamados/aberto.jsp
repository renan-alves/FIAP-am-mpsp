					...
					<form method="GET" action="${contextPath}/chamado/?">
						<div class="input-group mb-3">
		  					...
		  					<div class="input-group-append">
		    					<a href="" onclick="this.href='${contextPath}/chamado/aberto/'+document.getElementById('txt-protocolo').value" class="btn btn-outline-secondary">Buscar</a>
		  					</div>
						</div>
					</form>
							...
							<div class="col-5 m-auto">
								<div class="card text-center mb-3">
									...
									<div class="card-body">
										...
										<a href="${contextPath}/chamado/aberto/${item.protocoloChamado}" class="btn btn-primary">Visualizar</a>
									</div>
