					...
					<form method="GET" action="${contextPath}/chamado/?">
						<div class="input-group mb-3">
		  					...
		  					<div class="input-group-append">
		    					<a href="" onclick="this.href='${contextPath}/chamado/aguardando/'+document.getElementById('txt-protocolo').value" class="btn btn-outline-secondary">Buscar</a>
		  					</div>
						</div>
					</form>
			...
			<main class="col offset-2 h-100">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb mt-3">
				    	...
				    	<li class="breadcrumb-item active" aria-current="page">Aguardando Resposta</li>
					</ol>
				</nav>
